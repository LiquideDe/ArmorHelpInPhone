...
public class BallisticModifiersView : MonoBehaviour
{
    ...
    [SerializeField] Button _buttonPrevLight, _buttonPrevDistance, _buttonPrevShoot, _buttonPrevAiming, _buttonPrevTarget, _buttonPrevWeaponKit, 
        _buttonPrevHandle, _buttonPrevNavigate, _buttonPrevSize;
    [SerializeField] Button _buttonNextLight, _buttonNextDistance, _buttonNextShoot, _buttonNextAiming, _buttonNextTarget, _buttonNextWeaponKit, 
